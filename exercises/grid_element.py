"""
This class was completely taken from the tutorial. No changes have been made, except for a change in color! (line 67)
"""
    ...
    def draw_grid_element(self, surface):
        ...
        for direction in compass:
            if direction == (0, -1):  # North
                draw.line(surface, (255, 0, 0), (self.position[0] * self.size[0], self.position[1] * self.size[1]),
                          ((self.position[0] + 1) * self.size[0], self.position[1] * self.size[1]), 2)
            if direction == (1, 0):  # East
                draw.line(surface, (255, 0, 0), ((self.position[0] + 1) * self.size[0], self.position[1] * self.size[1]),
                          ((self.position[0] + 1) * self.size[0], (self.position[1] + 1) * self.size[1]), 2)
            if direction == (0, 1):  # South
                draw.line(surface, (255, 0, 0), (self.position[0] * self.size[0], (self.position[1] + 1) * self.size[1]),
                          ((self.position[0] + 1) * self.size[0], (self.position[1] + 1) * self.size[1]), 2)
